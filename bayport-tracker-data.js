...
• May 12/28: Brandon reported Tom completed framing.
...
• Lloyd security contract signed; installation can follow about one week after drywall
...
• Quartz counter is on site
• Electronic key hardware installed on 3 steel doors and front door
...
{id:'p2b',cat:'permits',n:'Exterior sign fabrication / install (Sir Metalman)',s:'2026-05-01',e:'2026-06-30',st:'active',pct:75,priority:'soon',cost:0,notes:`Owner: Sir Metalman / Brandon
May 1 update: final payment has been made.
May 28 update: exterior sign color was picked and Sir Metalman is working on fabrication.
Expected completion: mid-to-late June.
Next step: install sign when fabrication is complete.
...
{id:'e2c',cat:'site',n:'Finish rear fence panels/fabric after posts',s:'2026-06-01',e:'2026-06-09',st:'active',pct:60,priority:'now',cost:0,notes:`Owner: Brandon / ACT Asphalt coordination
...
{id:'i4c',cat:'interior',n:'Quartz counter install after drywall / painting',s:'2026-05-02',e:'2026-06-21',st:'active',pct:80,priority:'soon',cost:0,notes:`Owner: Brandon
...
{id:'sys10',cat:'systems',n:'Complete in-wall electrical / common-wire work',s:'2026-05-13',e:'2026-06-04',st:'done',pct:100,priority:'soon',cost:0,notes:`Owner: Brandon / electrician as needed
...
{id:'i3',cat:'interior',n:'ADA grab bars',s:'2026-04-14',e:'2026-05-28',st:'done',pct:100,priority:'later',cost:0,notes:`Owner: Brandon
May 28 update: ADA bars are installed in the bathroom.
...
May 28 update: electronic key hardware is installed in the 3 steel doors and on the front door.
Remaining: install electronic key hardware on the back door. Important to do soon so it is ready when Lloyd installs equipment.`},
...
{id:'e2',cat:'site',n:'ACT Asphalt quote + parking lot scope lock',s:'2026-04-21',e:'2026-05-28',st:'done',pct:100,priority:'soon',cost:15000,notes:`Owner: Brandon / Mitchell at ACT Asphalt
May 28 update: ACT Asphalt moved from quote/scope planning into active field installation.
Scope direction: include a paved drain approach that may avoid needing green space treatment.
Closeout: keep final quote/invoice/payment documentation with the parking lot record after field completion.
Cash assumption: still carrying a working first-payment placeholder of $15k until final invoice documentation is confirmed.`},
{id:'e2b',cat:'site',n:'Parking lot paving execution',s:'2026-05-20',e:'2026-06-04',st:'done',pct:100,priority:'soon',cost:15000,notes:`Owner: Brandon / ACT Asphalt
May 28 update: ACT Asphalt is actively installing the parking lot now and should be done this week.
Jun 4 update: parking lot is fully paved and complete.
Closeout: lock final documentation/payment status and keep final quote/invoice/payment docs with the project record.
Cash assumption: placeholder for remaining payment at completion until final quote/invoice documentation is confirmed.`},
