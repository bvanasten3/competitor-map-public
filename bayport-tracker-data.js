...
window.BAYPORT_TRACKER_DATA = {
  heroPills: [
    {
      "className": "primary",
      "text": "Top priority: schedule framing inspection now that framing is complete"
    },
    {
      "className": "warning",
      "text": "Property taxes paid: $7,476.75 on May 8"
    },
    {
      "className": "gold",
      "text": "Framing complete; inspection + switches/latches/toilet are next"
    }
  ],
  notes: {
    "nextActions": `TOP ACTIONS
• Schedule the building framing inspection now that Tom and crew have completed framing; Brandon expects roughly a 24-hour lead time for the city/inspector to come out.
• Use the inspection window to advance quick on-site work: install toilet, install smart switches if wiring matches expectations, and start electronic door latches now that framing is complete.
• Decide where/how to relocate the customer-facing light switches so shoppers cannot accidentally flip store lighting; coordinate electrician/switch changes before drywall closes walls.
• File City of Bayport permit payment receipts/docs for building, fence, sign, and sprinkler records.
• Confirm Dynamic Fire Protection service timing/closeout paperwork for sprinkler-head moves and keep the receipt with permit records.

WHY THIS ORDER
• City permit payments are done and framing is complete, so the active constraint is inspection scheduling rather than framing progress.
• Tom started framing on May 6 and Brandon reported framing complete on May 12; the next critical handoff is inspection request with ~24hr lead time.
• The biggest avoidable rework risk is pre-wall electrical/security decisions, especially light-switch placement in customer-accessible areas.`,
...
BUILDOUT / SCHEDULE
• May 7: Dynamic Fire Protection sprinkler-head move scheduling is done; keep service/closeout documentation with permit records.
• May 6: Tom started steel stud framing.
• May 12: Brandon reported Tom and crew completed framing; schedule the framing inspection next, usually with roughly 24hr lead time.
• Tom / father-son crew quote remains the working framing/drywall anchor at $15k.
• Framing readiness blockers are cleared enough for field work to proceed; before walls close, keep focus on security/window decisions and remaining targeted low-voltage runs: easy back-building wiring during equipment install plus the front exterior/front security door cable-use question.
...
• Bayport property taxes were paid May 8: $7,476.75; treat as completed non-capex runway cash outflow.
...
• Steel stud framing is complete; inspection scheduling is now the immediate handoff because inspector lead time is typically about 24 hours.
• Light-switch locations need a pre-wall decision so customers cannot accidentally flip store lighting; decide relocation/cover/staff-only controls before drywall.
• Security checkpoint window decision still needs to be finalized before drywall closes the relevant walls.
...
1. Schedule framing inspection now that framing is complete (~24hr lead time)
2. Use pre-inspection/pre-drywall window to solve customer-safe light switches and access hardware
3. Decide/coordinate light-switch relocation before drywall closes walls
4. File city permit payment docs/receipts and Dynamic Fire Protection paperwork
5. Finalize security window and front-door cable-use decision before drywall closes walls
6. Finish targeted back-building wiring during security-equipment install
7. Rough-in and system installs
8. Drywall / finish sequencing
9. SOP / operating plan + Plan of Record
10. OCM review / inspection / opening

RECENT WINS
• Interior-wall building permit received / marked complete
• All City of Bayport permit payments completed
...
• Dynamic Fire Protection sprinkler-head move scheduling completed
...
• Building framing inspection: schedule now that framing is complete; typical lead time is about 24 hours
• Electrical/smart switches: not yet installed as of May 12; install/verify staff-safe/customer-safe controls before drywall closes walls
• Electronic door latches: framing completion means Brandon can start installing access hardware soon
• Bathroom: wallpaper installed, tile is up except one wall, two walls grouted; next Bayport trip priority is installing the toilet for a functional bathroom
• Construction waste: call Minneapolis trash/bulk disposal before 4:30 PM, schedule one day in advance, and complete drop-off this week
...
SPEND SNAPSHOT
• Bayport property taxes paid May 8: $7,476.75; non-capitalized cash outflow, important for runway.
• City permit payments are complete; receipts/docs should be filed with project records.
• Construction in Process transaction report through May 13 shows 2026 capex additions of $40,023.57 and ending CIP balance of $43,023.57 including the $3,000 beginning balance.
• P&L screenshot through May 13 shows total ordinary expenses of $13,795.73, interest/other expense of $17,085.11, rent income of $2,603.23, and net income of -$28,277.61.
...
• Target opening: Aug 1, 2026`
  ...
  importantIds: ['s2','p5','sys9','h1b','sys7','i4c','d1','d3','sec2','sec4','c5','c5b','c2','e2','e2b'],
  ...
  actuals: [
    ...
    {year:2026,month:0,cat:'permits',amount:12475.00},
    {year:2026,month:0,cat:'interior',amount:446.81},
    {year:2026,month:1,cat:'mech',amount:758.61},
    {year:2026,month:2,cat:'framing',amount:1284.78},
    {year:2026,month:2,cat:'interior',amount:849.29},
    {year:2026,month:2,cat:'mech',amount:172.14},
    {year:2026,month:2,cat:'site',amount:2782.87},
    {year:2026,month:2,cat:'systems',amount:834.44},
    {year:2026,month:3,cat:'framing',amount:3373.92},
    {year:2026,month:3,cat:'interior',amount:2179.71},
    {year:2026,month:3,cat:'mech',amount:284.03},
    {year:2026,month:3,cat:'systems',amount:1333.84},
    {year:2026,month:3,cat:'site',amount:698.36},
    {year:2026,month:3,cat:'retail',amount:5592.25},
    {year:2026,month:4,cat:'permits',amount:654.01},
    {year:2026,month:4,cat:'site',amount:5551.76},
    {year:2026,month:4,cat:'retail',amount:152.64},
    {year:2026,month:4,cat:'systems',amount:158.83},
    {year:2026,month:4,cat:'interior',amount:440.28}
  ],
  tasks: [
...
May 7 update: city permit payment is complete; keep formal documentation and payment receipt filed with the project records.
...
Status: no longer a dashboard watchlist item; May 7 city permit payment is complete.
...
May 12 update: Brandon has two exterior sign color samples and wants to discuss with Natalie before final color selection.
...
May 7 update: city permit payment is complete. Next workstream is fence execution timing, not permit approval.`},
...
May 8 update: Brandon paid Bayport property taxes. Actual total paid: $7,476.75.
Planning treatment: non-capitalized property tax / P&L cash outflow, but include in near-term runway and cash-flow history because it landed alongside permit, sprinkler, framing, and other buildout payments.`},
...
{id:'s2',cat:'framing',n:'Interior framing & drywall',s:'2026-05-06',e:'2026-05-29',st:'active',pct:45,priority:'now',cost:15000,notes:`Owner: Brandon / Tom father-son crew
Tom quote is $15k.
May 7 update: Tom started framing May 6.
May 12 update: Tom and crew completed framing.
Next handoff: call/schedule the building framing inspection now; Brandon expects roughly 24hr lead time to get the inspector out.
Blockers/watchlist: remaining pre-wall watch items are light-switch relocation, checkpoint window direction, and any low-voltage/electrical/security decisions before drywall closes walls.
...
{id:'p5',cat:'permits',n:'Schedule framing inspection after framing complete',s:'2026-05-12',e:'2026-05-13',st:'active',pct:10,priority:'now',cost:0,notes:`Owner: Brandon / City inspector / SAFEbuilt as applicable
May 12 update: framing is complete. Brandon needs to schedule the framing inspection in the next couple of days. Typical lead time is about 24 hours, so call immediately rather than waiting until drywall sequencing starts.
Dependency: framing substantially complete and accessible for inspection before drywall closes anything.`},
...
{id:'h1b',cat:'mech',n:'Schedule Dynamic Fire Protection sprinkler-head moves',s:'2026-04-16',e:'2026-05-07',st:'done',pct:100,priority:'soon',cost:1500,notes:`Owner: Brandon / Dynamic Fire Protection
May 7 update: scheduling Dynamic Fire Protection for sprinkler-head moves is done.
Closeout/admin: file Dynamic Fire Protection invoice/receipt and any sprinkler service/closeout documentation with the permit records once available.
Impact: sprinkler coordination is no longer the main framing blocker; active field constraint is framing -> inspection.
Cash assumption: placeholder for moving sprinkler heads, should be replaced with real Dynamic Fire Protection invoice when available.`},
...
{id:'i2',cat:'interior',n:'Bathroom remodel materials + work',s:'2026-04-14',e:'2026-05-21',st:'active',pct:75,priority:'soon',cost:3500,notes:`Owner: Brandon / Natalie
May 10 update: big weekend progress. Paper towel holder installed; wallpaper installed; bottom ~4 feet of wall tile started.
May 12 update: wallpaper is installed; tile is up except one wall; Brandon grouted two walls and wants to install the toilet next time he is out so the bathroom is functional during continuing property work.
Remaining sequence: tile the final wall, finish grout/fixture sequencing, install toilet, then sink and remaining fixtures.
...
{id:'sys7',cat:'systems',n:'Low-voltage / security / AV pre-wire before drywall',s:'2026-04-17',e:'2026-05-12',st:'active',pct:85,priority:'soon',cost:1200,notes:`Owner: Brandon
...
May 7 watch item: coordinate with light-switch relocation decision before drywall closes walls.
...
{id:'sys9',cat:'systems',n:'Relocate / smart-control customer-facing light switches before drywall',s:'2026-05-07',e:'2026-05-13',st:'active',pct:20,priority:'now',cost:750,notes:`Owner: Brandon / electrician as needed
...
Decision path: identify every customer-accessible switch, choose staff-only locations behind counter/back-of-house or use a lockable/covered/smart-control path where relocation is impractical, then coordinate electrician work with rough-in if needed.
Safety note: kill breaker power, verify dead circuit, and photograph existing wiring before replacing any switch.
...
Dependency: paint the 3 steel welded-frame doors first, then install electronic key hardware / access-control hardware. May 12 update: now that framing is complete, Brandon can start installing electronic door latches soon.`},

{id:'e4',cat:'site',n:'Dispose Bayport construction waste / bulk drop-off',s:'2026-05-13',e:'2026-05-16',st:'todo',pct:0,priority:'soon',cost:0,notes:`Owner: Brandon
...
Reminder scheduled for May 13 at 8:30 AM CDT.`},
